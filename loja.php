<?
	...
	$sql_produtos = mysqli_query($link, 'SELECT * FROM loja_produto WHERE id_loja = "'.$loja['id'].'" AND ativo = 1 AND quantidade > 0');
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
	...
	<section id="services">
		<div class="container">
			<div class="row">
				...
				<?
					while($produtos = mysqli_fetch_array($sql_produtos)){
						echo '
							<div class="col-md-3">
								<div class="panel panel-default">
									<div class="panel-body">
										'.(($produtos['foto_principal'] == '')?'<img src="https://rsutilidadesdomesticas.shopping.marketup.com/Content/Images/sem-foto.gif" style="width: 100%">':'<img src="https://rsutilidadesdomesticas.shopping.marketup.com/Content/Images/sem-foto.gif" style="width: 100%">').'
									</div>
									<div class="panel-footer">
										...
										<div class="row">
											<div class="col-md-6 col-xs-12">
												<a class="btn btn-block btn-primary">R$'.number_format($produtos['valor'], 2, ',', '.').'</a>
											</div>
											<div class="col-md-6 col-xs-12">
												<a href="produto.php?loja='.$loja['url'].'&produto='.$produtos['url'].'" class="btn btn-block btn-success">Comprar</a>
											</div>
										</div>
									</div>
								</div>
